...
@section('breadcrumb')
            ...
            <div class="breadcrumb-line">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Unit Bin Filler - {{ \Session::get('no_permohonan')}} - {{ \Session::get('id_periksa')}}</li>
                </ul>
...
if (isset($pm_satu_amp_binfiller)) {
    if($pm_satu_amp_binfiller->kode_periksa){
        ...
        $no_id = $pm_satu_amp_binfiller->no_id;
        $id_periksa = $pm_satu_amp_binfiller->id_periksa;
