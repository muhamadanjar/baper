...
@section('breadcrumb')
            ...
            <div class="breadcrumb-line">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Unit Bin Panas Atau Hot Bin</li>
                </ul>
    ...
    <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="{{ url('amp/pemeriksa/unitbindingin') }}">
		...
		<div class="form-group">
			<div class="col-md-6 col-md-offset-4">
				...
				<a href="{{ url('amp/pemeriksaan2/unitsaringanbergetar') }}" class="btn btn-info">Balik</a>
				<a href="{{ url('amp/pemeriksaan2/unittimbangan') }}" class="btn btn-info">Lanjut</a>
			</div>
		</div>
	</form>
