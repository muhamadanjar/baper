...
@endsection
@section('content')
    <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="{{ url('amp/pemeriksa/unittimbangan') }}">
		...
		<div class="table-responsive">
                            <table class="table table-bordered" fixed-header>                               
                                ...
                                <tr>
									<td>3</td>
                                    <td>Unit Hidrolis / Pneumatik Bukaan Timbangan</td>
