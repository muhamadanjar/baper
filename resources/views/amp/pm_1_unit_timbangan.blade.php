...
@section('breadcrumb')
            ...
            <div class="breadcrumb-line">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Unit Timbangan - {{ \Session::get('no_permohonan')}} - {{ \Session::get('id_periksa')}}</li>
                </ul>
...
if (isset($pm_satu_amp_timbangan)) {
    if($pm_satu_amp_timbangan->kode_periksa){
        ...
        $no_id = $pm_satu_amp_timbangan->no_id;
        $id_periksa = $pm_satu_amp_timbangan->id_periksa;
