...
@section('breadcrumb')
            ...
            <div class="breadcrumb-line">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Unit Pengumpul Debu - {{ \Session::get('no_permohonan')}} - {{ \Session::get('id_periksa')}}</li>
                </ul>
...
if (isset($pm_satu_amp_pengumpuldebu)) {
    if($pm_satu_amp_pengumpuldebu->kode_periksa){
        ...
        $no_id = $pm_satu_amp_pengumpuldebu->no_id;
        $id_periksa = $pm_satu_amp_pengumpuldebu->id_periksa;
