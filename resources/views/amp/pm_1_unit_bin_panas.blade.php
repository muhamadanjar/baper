...
@section('breadcrumb')
            ...
            <div class="breadcrumb-line">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Unit Bin Panas - {{ \Session::get('no_permohonan')}} - {{ \Session::get('id_periksa')}}</li>
                </ul>
...
if (isset($pm_satu_amp_binpanas)) {
    if($pm_satu_amp_binpanas->kode_periksa){
        ...
        $no_id = $pm_satu_amp_binpanas->no_id;
        $id_periksa = $pm_satu_amp_binpanas->id_periksa;
