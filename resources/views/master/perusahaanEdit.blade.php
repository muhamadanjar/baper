			...
			<form class="form-horizontal form-bordered" method="post" role="form">
	            ...
	            <div class="panel panel-default">
	                <div class="panel-heading">
	                	<h6 class="panel-title"><i class="icon-menu"></i> Ubah Perusahaan</h6>
	                ...
	                <div class="panel-body">
				        ...
				        <div class="form-group">
				            ...
				            <div class="col-sm-2">
				            	<input type="text" class="form-control" readonly name="kode_perusahaan" value="{{ $perusahaan->kode_perusahaan}}">
				            </div>
				        </div>
						...
						<div class="form-group">
				            ...
				            <div class="col-sm-10">
				            	<input type="text" class="form-control" name="pic" value="{{ $perusahaan->pic }}">
				            </div>
				        </div>
						...
						<div class="form-group">
				            ...
				            <div class="col-sm-10">
				            	<input type="text" class="form-control" name="telp" value="{{ $perusahaan->telp }}">
				            </div>
				        </div>
