...
class TblAmp1UnitBinDingin extends Migration {
	...
	public function up(){
		Schema::create('tbl_amp_1_unit_bin_dingin', function (Blueprint $table) {
            ...
            $table->char('pelat_pemisah_check',1)->nullable();
            $table->string('pelat_pemisah_ket',120)->nullable();
            $table->string('pelat_pemisah_foto',120)->nullable();
            
			$table->char('dinding_bin_check',1)->nullable();
			$table->string('dinding_bin_ket',120)->nullable();
            $table->string('dinding_bin_foto',120)->nullable();
			...
			$table->char('pelindung_bin_check',1)->nullable();
			$table->string('pelindung_bin_ket',120)->nullable();
            $table->string('pelindung_bin_foto',120)->nullable();
